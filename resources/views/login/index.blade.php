    ...
    <section class="login bg-light section-padding d-flex justify-content-center align-items-center">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-7 col-lg-6 col-xl-5 py-5 px-4 px-sm-5">
                <div class="login-box">
                    {{-- <h2 class="form-title text-center">Login Administrator</h2> --}}
                    <div class="brand-logo mb-3">
                        <img src="{{ asset('img/logo-dark.png') }}" class="d-flex m-auto" alt="logo" style="width: 120px">
                    </div>
                    <h6 class="text-capitalize mb-2">Login Administrator</h6>
                    <form action="/login" method="post">
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <button class="btn btn-2 w-100 py-3 px-5" type="submit" id="login">
                              Login
                            </button>
                          </div>
                        </div>
